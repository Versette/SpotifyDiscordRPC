...
public class SpotifyMemoryClient
{
    ...
    private const string SongDurationAddress = "base+0131466C,0,44,4,34,6c,4,24,0,1c8";
    ...
    private static readonly string[]
        TitleArtistAddresses =
        {
            ...
            "libcef.dll+08C55400,15c,8,8,8,14,4,c4,0", "libcef.dll+08BD9D44,10,44,18c,a0,10,74,20,18,0",
            "libcef.dll+08BD9D44,10,44,d4,ec,48,74,20,18,0"
    ...
    private void ThreadWork()
    {
        while (!_disposed)
        {
            ...
            if (titleArtistString.Contains("•"))
            {
                ...
                // Thumbnail
                var coverArtId = "";
                var coverResult = _memory.ReadString(ThumbnailAddress, length: 200).Replace("e:", "");
                if (!localFile && !coverResult.Contains("fileimag"))
                    coverArtId = "https://i.scdn.co/image/" + coverResult;
                else
                    localFile = true;
